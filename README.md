...
Built using a **custom agent loop (Reason → Act → Observe)** without external frameworks like LangChain, and deployed as a **Streamlit chat application**.
...
6. Steps repeat until a final answer is generated
7. The full reasoning trace (action → observation) is shown in the UI
...
### 🧮 Calculator
![Calculator](screenshots/calculator_demo.JPG)
